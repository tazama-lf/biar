...
# PATHS
# ---------------------------
WAREHOUSE_ROOT = "/root/muneeb-faraz/Hudi_Test_Postgres/Tazama_Hudi_warehouse"
...
# ---------------------------
# Spark Session (Hudi enabled + 20GB Limits)
# ---------------------------
spark = (
    ...
    .config("spark.jars", "/home/muneeb-faraz/Hudi_Test_Postgres/hudi-spark3.4-bundle_2.12-0.14.1.jar")
    # --- MEMORY UPGRADES ---
    .config("spark.driver.memory", "24g")         # Must have physical RAM to support this
    .config("spark.executor.memory", "24g")       # Must have physical RAM to support this
    .config("spark.driver.maxResultSize", "20g")  # Allows moving 20GB of data
...
if __name__ == "__main__":
    uvicorn.run("FAST_API_For_BronzeRawData:app", host="0.0.0.0", port=8181, reload=True)